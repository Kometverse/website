...
export const Hero = () => {
    return (
        <>
            <div className=" flex flex-col items-center text-center w-[90%] mt-5   pb-6 rounded-2xl pt-8  backdrop-blur  bg-[#2A2A3C] sm:max-w-[600px] m-auto sm:pt-20 sm:pb-20 lg:max-w-[700px] sm:mt-20 lg:rounded-[90px]  lg:mb-20 sm:mb-10 ">
