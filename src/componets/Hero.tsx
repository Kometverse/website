...
export const Hero = () => {
    return (
        <>
            <div className="w-full lg:h-[90vh]  flex  flex-col items-center justify-center">
                ...
                <p className="flex font-normal text-xl lg:text-2xl mb-4">Send, swap and earn - like a pro <img className=" mx-2 w-5" src={emoji} alt="" /> </p>
                <a href="#cta">
