...
export const TiltCards = () => {
  return (
    <>
      ...
      <div className="lg:w-[90%] w-full relative  flex-col flex lg:items-center lg:flex-row space-between  m-auto my-15 sm:mb-28 lg:mb-32">
        <Tilt
          tiltEnable={true}
          tiltReverse={true}
          ...
          <p className="lg:text-xl text-lg text-left w-[25ch] px-6 ">
